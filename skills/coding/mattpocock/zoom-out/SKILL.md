...
⚠️ This skill is **cherry-picked from upstream**. The authoritative version lives at:
  https://github.com/mattpocock/skills/engineering/tree/main/skills/zoom-out
...
cp /tmp/mattpocock-skills/skills/zoom-out/SKILL.md ./SKILL.md  # this file, replaced
```
