---
name: tr-medical-translate
description: TR ↔ EN translation for clinical text. Two-model bridge: Turkish-Gemma-9b-T1 for TR side, Qwen 3.6 for EN medical accuracy. Preserves precise medical terminology.
domain: research
...
# Tr Medical Translate

TR ↔ EN translation for clinical text. Two-model bridge: Turkish-Gemma-9b-T1 for TR side, Qwen 3.6 for EN medical accuracy. Preserves precise medical terminology.
...
Turkish-Gemma-9b-T1 (YTU CE Cosmos). For TR-only sessions, routes entirely to Turkish-Gemma.
