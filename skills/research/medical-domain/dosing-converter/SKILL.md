---
name: dosing-converter
description: Pediatric drug dosing — mg/kg → total dose, BSA → total dose, steroid equivalence (replicates Bora's existing ÇEDD steroid-conversion tool as a skill).
domain: research
...
Pediatric drug dosing — mg/kg → total dose, BSA → total dose, steroid equivalence (replicates Bora's existing ÇEDD steroid-conversion tool as a skill).
...
Bora's existing ceddcozum.vercel.app/tools/steroid-conversion logic, surfaced as a skill.
