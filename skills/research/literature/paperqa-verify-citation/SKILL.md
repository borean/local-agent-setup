---
name: paperqa-verify-citation
description: For each [bibkey:page] in a draft, confirm the cited claim actually appears at that page in the local PDF.
domain: research
pillar: literature
user-invocable: true
target_models:
...
For each [bibkey:page] in a draft, confirm the cited claim actually appears at that page in the local PDF.
...
PaperQA2 source-verification mode. Closes the loop on hallucinated citations.
