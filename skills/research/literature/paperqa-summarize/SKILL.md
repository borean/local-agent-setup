---
name: paperqa-summarize
description: Structured single-paper summary in IMRaD form (title/authors/year/design/n/population/intervention/comparator/primary outcome/key findings/limitations/bias risk). Backed by PaperQA2.
domain: research
pillar: literature
user-invocable: true
target_models:
...
Structured single-paper summary in IMRaD form (title/authors/year/design/n/population/intervention/comparator/primary outcome/key findings/limitations/bias risk). Backed by PaperQA2.
...
PaperQA2 (Future House, Apache-2.0). Wraps the `pqa summarize` CLI.
