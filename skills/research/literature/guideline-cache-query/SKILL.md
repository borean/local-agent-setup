---
name: guideline-cache-query
description: Query cached clinical guideline corpus (MAGICapp/ISPAD/ESPE/ÇEDD/AAP/ATA) by condition + age + country.
domain: research
pillar: literature
user-invocable: true
target_models:
...
# Guideline Cache Query

Query cached clinical guideline corpus (MAGICapp/ISPAD/ESPE/ÇEDD/AAP/ATA) by condition + age + country.
...
MAGICapp + the individual society dumps. Refreshed via momentary-internet weekly.
