---
name: paperqa-synthesize
description: N paper summaries + research question → narrative synthesis with [bibkey:page] citations at every claim.
domain: research
pillar: literature
user-invocable: true
target_models:
...
N paper summaries + research question → narrative synthesis with [bibkey:page] citations at every claim.
...
PaperQA2's `pqa ask` mode. Citation-first by design.
