---
name: analysis-plan
description: Given research question + data dictionary, propose 5 analyses ranked by clinical relevance with assumptions + robustness checks. Uses Two-Phase Generator-Evaluator: blind acceptance criteria first, then sighted plan.
domain: research
pillar: statistics
user-invocable: true
target_models:
...
Given research question + data dictionary, propose 5 analyses ranked by clinical relevance with assumptions + robustness checks. Uses Two-Phase Generator-Evaluator: blind acceptance criteria first, then sighted plan.
...
Two-Phase Generator-Evaluator pattern from ARS (Imbad0202/academic-research-skills). Cherry-picked May 14-15.
