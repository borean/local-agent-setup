---
name: statistical-test-picker
description: Outcome × predictor(s) × design × n → recommended test, assumptions, robustness alternatives, R + Python stubs.
domain: research
pillar: statistics
user-invocable: true
target_models:
...
Outcome × predictor(s) × design × n → recommended test, assumptions, robustness alternatives, R + Python stubs.
...
Synthesis of intro biostats decision trees (Altman, Bland) + GraphPad GUI logic.
