...
description: Given analysis outputs (numbers, not raw rows), produce clinical interpretation with explicit uncertainty and caveats.
domain: research
pillar: statistics
user-invocable: true
target_models:
...
Given analysis outputs (numbers, not raw rows), produce clinical interpretation with explicit uncertainty and caveats.
...
Pattern: numbers in, qualitative narrative out. Never sees PHI.
