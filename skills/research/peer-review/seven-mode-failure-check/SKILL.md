---
name: seven-mode-failure-check
description: Explicit check for 7 AI research failure modes: frame-lock, hallucinated results, fabricated methods, premature synthesis, citation drift, scope creep, sycophancy.
domain: research
pillar: peer-review
user-invocable: true
target_models:
...
# Seven Mode Failure Check

Explicit check for 7 AI research failure modes: frame-lock, hallucinated results, fabricated methods, premature synthesis, citation drift, scope creep, sycophancy.
...
From ARS. 7-Mode Failure Checklist. Each mode has its own detection heuristic.
