---
name: rob-assessor
description: ROB-2 (RCT) or ROBINS-I (observational) risk-of-bias assessment, domain by domain. Returns judgement + rationale + quotes from paper.
domain: research
pillar: peer-review
user-invocable: true
target_models:
...
ROB-2 (RCT) or ROBINS-I (observational) risk-of-bias assessment, domain by domain. Returns judgement + rationale + quotes from paper.
...
Cochrane ROB-2 (Sterne et al. 2019, BMJ) and ROBINS-I (Sterne et al. 2016, BMJ).
