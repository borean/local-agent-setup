---
name: claim-check
description: Split draft into atomic claims. Classify each as {cited, needs-citation, common-knowledge, opinion}. Flag the needs-citation ones.
domain: research
pillar: manuscript
user-invocable: true
target_models:
...
Split draft into atomic claims. Classify each as {cited, needs-citation, common-knowledge, opinion}. Flag the needs-citation ones.
...
Pattern: turn writing into a verification graph.
