---
name: anti-leakage
description: Scan draft for fabricated methods/hallucinated data. Force [MATERIAL GAP: <description>] tags where the model invented content not traceable to inputs.
domain: research
pillar: manuscript
user-invocable: true
target_models:
...
Scan draft for fabricated methods/hallucinated data. Force [MATERIAL GAP: <description>] tags where the model invented content not traceable to inputs.
...
From ARS (Imbad0202/academic-research-skills). The single biggest defense against open-weight hallucination.
