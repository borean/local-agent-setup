...
description: Journal-specific abstract structure (JCEM, JPEM, Diabetes Care, Lancet Endo, etc.) with word counts and section headers.
domain: research
pillar: manuscript
user-invocable: true
target_models:
...
Journal-specific abstract structure (JCEM, JPEM, Diabetes Care, Lancet Endo, etc.) with word counts and section headers.
...
Per-journal templates from instructions-to-authors. Update yearly.
