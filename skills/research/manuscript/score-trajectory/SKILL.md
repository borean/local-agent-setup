...
description: Across manuscript revisions, score each on N dimensions (methodology, writing, citations, figures, statistics, integrity, novelty). Flag regressions where one dimension drops while another rises.
domain: research
pillar: manuscript
user-invocable: true
target_models:
...
Across manuscript revisions, score each on N dimensions (methodology, writing, citations, figures, statistics, integrity, novelty). Flag regressions where one dimension drops while another rises.
...
From ARS. Catches fix-A-break-B during revision rounds. Feeds the cron/weekly/manuscript-snapshot trail.
